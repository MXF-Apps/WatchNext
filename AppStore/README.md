...
| `Metadata/en-US.md` | Paste-ready App Store Connect text: name, subtitle, promo text, description, keywords, category, age rating, privacy answers, export compliance, review notes, screenshot captions. |
